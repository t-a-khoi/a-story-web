      ...
      <div className="max-w-3xl mx-auto space-y-8 pb-20">
        ...
        <div className="bg-navy-50 border border-navy-100 rounded-3xl p-6 md:p-8 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-6 relative overflow-hidden">
          <div className="absolute top-0 right-0 p-4 opacity-10 pointer-events-none">
            <BookOpen className="w-32 h-32 text-navy-900" aria-hidden="true" />
          </div>
        ...
        <Link
          href="/write"
          className="flex items-center justify-center gap-3 w-full bg-gold-500 hover:bg-gold-600 text-pearl-50 font-bold py-5 px-6 rounded-2xl min-h-[64px] transition-colors shadow-sm active:scale-[0.98] relative z-10"
        ...
        <section aria-label={t("home.emptyTitle")}>
          {isLoadingStories ? (
            <div className="flex flex-col items-center justify-center py-20 space-y-4 bg-pearl-100 rounded-3xl border border-pearl-200">
              <Loader2 className="w-10 h-10 text-navy-500 animate-spin" aria-hidden="true" />
            ...
            <div className="flex flex-col items-center justify-center py-20 px-6 text-center bg-pearl-50 rounded-3xl border border-pearl-200 border-dashed">
              <BookHeart className="w-16 h-16 text-navy-100 mb-4" aria-hidden="true" />
            ...
            <div ref={ref} className="flex justify-center py-8 opacity-75">
              {isFetchingNextPage ? (
                <div className="flex items-center gap-3 bg-pearl-50 px-5 py-2.5 rounded-full shadow-sm border border-pearl-200">
                  ...
                  <span className="text-navy-700 font-semibold">{t("home.loadingMore")}</span>
                </div>
              ) : !hasNextPage ? (
