        ...
        <div className="relative">
            ...
            <input
                ...
                className={`block w-full pl-11 pr-4 py-3 border rounded-xl bg-white focus:outline-none focus:ring-2 transition-all text-md ${error
                    ...
                    : 'border-pearl-200 text-charcoal-900 placeholder-stone-400 focus:ring-teal-300 focus:border-teal-500'
                    }`}
            />
        </div>
        {error && (
    ...
    return (
        <div className="min-h-screen bg-pearl-50 text-charcoal-800 flex flex-col font-sans">
            <header className="py-5 bg-white/80 backdrop-blur-sm sticky top-0 z-50 border-b border-pearl-200">
                <nav className="max-w-7xl mx-auto px-6 flex items-center justify-between">
                    <Link href="/home" className="flex items-center gap-2 md:gap-3 p-1 md:p-2 rounded-lg hover:bg-pearl-100 transition">
                        <span className="text-xl md:text-2xl font-extrabold text-teal-900 tracking-tight">
                            A Story.
                        </span>
                    </Link>
            ...
            <main className="flex-grow flex items-center justify-center py-16 px-6 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-[40vw] h-[40vw] bg-bronze-200/20 rounded-full blur-[100px] pointer-events-none -translate-y-1/2 translate-x-1/2"></div>
                <div className="absolute bottom-0 left-0 w-[30vw] h-[30vw] bg-teal-200/20 rounded-full blur-[80px] pointer-events-none md:translate-y-1/2 -translate-x-1/2"></div>
                ...
                >
                    <div className="bg-white p-10 md:p-16 rounded-[40px] shadow-sm border border-pearl-200">
                        <div className="text-center mb-12">
                            <h1 className="text-5xl font-serif font-extrabold text-teal-900 leading-tight">
                        ...
                        <form className="space-y-12" onSubmit={handleSubmit}>
                            ...
                            <div className="bg-pearl-50 p-6 md:p-8 rounded-3xl border border-pearl-200">
                                <h3 className="flex items-center gap-2 text-2xl font-bold text-teal-800 mb-6 pb-4 border-b border-pearl-200">
                                    <Lock className="w-6 h-6 text-bronze-500" />
                            ...
                            <div className="bg-pearl-50 p-6 md:p-8 rounded-3xl border border-pearl-200">
                                <h3 className="flex items-center gap-2 text-2xl font-bold text-teal-800 mb-6 pb-4 border-b border-pearl-200">
                                    <User className="w-6 h-6 text-bronze-500" />
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <select name="gender" required value={formData.gender} onChange={handleChange} className="block w-full pl-11 pr-4 py-3 border border-pearl-200 rounded-xl text-charcoal-900 bg-white focus:outline-none focus:ring-2 focus:ring-teal-300 focus:border-teal-500 transition-all text-md appearance-none">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <select name="userType" required value={formData.userType} onChange={handleChange} className="block w-full pl-11 pr-4 py-3 border border-pearl-200 rounded-xl text-charcoal-900 bg-white focus:outline-none focus:ring-2 focus:ring-teal-300 focus:border-teal-500 transition-all text-md appearance-none">
                            ...
                            <div className="pt-4">
                                <button
                                    type="submit"
                                    disabled={isLoading}
                                    className="w-full min-h-[60px] flex items-center justify-center gap-3 px-8 py-4 bg-white text-teal-700 border-2 border-teal-500 rounded-2xl text-lg font-bold shadow-sm hover:bg-teal-50 hover:scale-[1.01] hover:shadow-md transition-all disabled:opacity-75 disabled:cursor-not-allowed group"
                                >
                                    {isLoading ? (
                                        <>
                                        ...
                                        <>
                                            ...
                                            <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform text-bronze-400" />
                                        </>
                                    )}
                                </button>
                            </div>
...
function LanguageToggle() {
    ...
    return (
        ...
        >
            <span className="absolute left-2 text-[10px] font-bold text-teal-700 select-none">VI</span>
            <span className="absolute right-2 text-[10px] font-bold text-teal-700 select-none">EN</span>
